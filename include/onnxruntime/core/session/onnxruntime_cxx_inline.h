...
inline SessionOptions& SessionOptions::AppendExecutionProvider_SNPE(bool enforce_dsp) {
  ThrowOnError(GetApi().SessionOptionsAppendExecutionProvider_SNPE(p_, enforce_dsp));
  return *this;
}
