...
if (onnxruntime_ENABLE_TRAINING)
  ...
  file(GLOB onnxruntime_python_ortmodule_configuration_srcs CONFIGURE_DEPENDS
    "${ORTTRAINING_SOURCE_DIR}/python/training/ortmodule/configuration/*.py"
  )
...
if (onnxruntime_ENABLE_TRAINING)
  add_custom_command(
    ...
    COMMAND ${CMAKE_COMMAND} -E make_directory $<TARGET_FILE_DIR:${build_output_target}>/onnxruntime/training/ortmodule/configuration
    ...
    COMMAND ${CMAKE_COMMAND} -E copy
        ${onnxruntime_python_ortmodule_configuration_srcs}
        $<TARGET_FILE_DIR:${build_output_target}>/onnxruntime/training/ortmodule/configuration/
    COMMAND ${CMAKE_COMMAND} -E copy
