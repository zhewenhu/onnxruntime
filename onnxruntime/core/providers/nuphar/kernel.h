...
#define LIST_NUPHAR_OPS()                                                                    \
  ...
  NUPHAR_VERSIONED_OP(ArgMax, 1, 12, DataTypeImpl::AllFixedSizeTensorTypes())                \
  NUPHAR_OP(ArgMax, 13, DataTypeImpl::AllFixedSizeTensorTypes())                             \
  NUPHAR_VERSIONED_OP(ArgMin, 1, 12, DataTypeImpl::AllFixedSizeTensorTypes())                \
  NUPHAR_OP(ArgMin, 13, DataTypeImpl::AllFixedSizeTensorTypes())                             \
  ...
  NUPHAR_OP(LogSoftmax, 13, DataTypeImpl::AllIEEEFloatTensorTypes())                         \
  ...
  NUPHAR_VERSIONED_OP(Pad, 2, 12, DataTypeImpl::AllIEEEFloatTensorTypes())                   \
  NUPHAR_OP(Pad, 13, DataTypeImpl::AllIEEEFloatTensorTypes())                                \
  ...
  NUPHAR_OP(Softmax, 13, DataTypeImpl::AllIEEEFloatTensorTypes())                            \
